...
@Command(name = "read", mixinStandardHelpOptions = true, description = "Read a single cell value.")
public final class ReadCommand implements Callable<Integer>
{
	...
	public ReadCommand(final XlFacade facade)
	{
		this.facade = facade;
	}
	...
	public Integer call()
	{
		return facade.readCell(file, sheet, cellReference).fold(
				value ->
				{
